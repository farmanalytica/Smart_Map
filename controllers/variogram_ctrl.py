...
class VariogramController:
    ...
    def plot_variogram(self):
        ...
        try:
            ...
            self.view.groupBox_Krigagem.setEnabled(True)
            self.view.lineEdit_OK_VBNumMax.setEnabled(True)
            self.view.lineEdit_OK_VBRaio.setEnabled(True)
            self.view.checkBox_Krigagem_Alcance.setEnabled(True)
            self.view.pushButton_Krigagem.setEnabled(True)
            self.view.checkBox_Krigagem_Std_Desv.setEnabled(True)

            self.view.label_Krigagem.hide()
            self.view.label_validacao_cruzada_OK.hide()
            self.view.pushButton_Validacao_Cruzada_OK.setEnabled(True)

            self.view.datatable_pontos_interpolados_OK.setColumnCount(0)
            self.view.datatable_pontos_interpolados_OK.setRowCount(0)
    ...
    def on_vb_num_max_edited(self):
        ...
        try:
            vb = int(self.view.lineEdit_OK_VBNumMax.text())
    ...
    def on_vb_raio_edited(self):
        ...
        try:
            raio = float(self.view.lineEdit_OK_VBRaio.text())
    ...
    def on_variogram_reset_clicked(self):
        ...
        self.view.lineEdit_OK_VBRaio.setText('%.3f' % self.data_ctrl.max_dist)
